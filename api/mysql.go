...
func NewTable() error {
	db := NewDb()
	defer db.Close()
	_, err := db.Exec("CREATE TABLE IF NOT EXISTS USERS (USER_ID varchar(45) NOT NULL, PW binary NOT NULL, NAME varchar(45) NOT NULL, EMAIL varchar(100) NOT NULL, TEL varchar(45) DEFAULT NULL, LAST_ACCESS_DT datetime DEFAULT NULL, UPDATE_DT datetime DEFAULT NULL, CREATE_DT datetime DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (USER_ID) ) ENGINE = InnoDB DEFAULT CHARSET=utf8mb4;")
	if err != nil {
